        ...
        <Container>
            <Row>
                ...
                >
                    ...
                    <div>
                        <h3>
                            Welcome to CODEing BUDDY!
                        </h3>
                        <p>
                            I am here to help you when you are coding 
                            or are starting to learn a new language! 
                            I hope that I can be your buddy for all your 
                            programming needs {' (:'}
                        </p>
                        <p>
                            The programming languages that I can help you out 
                            with as of right now are: 
                        </p>
                        <ul>
                            <li>
                                C++
                        ...
                        <p>
                            {'('}don't worry about the limited languages, 
